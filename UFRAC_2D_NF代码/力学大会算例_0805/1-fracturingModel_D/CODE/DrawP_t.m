function DrawP_t(nt,curT)
global  AllEle_global    
global PicScale;
global   nAct  IndexInv  CpF_global PresF_global
global FILEPATH ;
...
title(['Pres@ Time ',num2str(curT)/60,'min'],'Fontsize',14);
axis equal;
% axis(PicScale);
colorbar;
...
n = (Ly/Lx);
set(34,'Position',[300 0 600 600*n])
saveas(34,[FILEPATH,num2str(nt),'Pres_t.fig']);
