    ...
    if (abs(AllEle(i,10) - 3) < 1e-6) ||  abs(AllEle(i,10) - 1) < 1e-6 || abs(AllEle(i,10) - 6) < 1e-6
        ...
        if Ds(Index(i)) < -1e-10
          %  plot([AllEle(i,8)+abs(Ds(Index(i)))/2*AllEle(i,5),AllEle(i,8)-abs(Ds(Index(i)))/2*AllEle(i,5)],[AllEle(i,9)-abs(Ds(Index(i)))/2*AllEle(i,6),AllEle(i,9)+abs(Ds(Index(i)))/2*AllEle(i,6)],'b','LineWidth',0.5);
            ...
            plot([AllEle(i,8)+abs(Ds(Index(i)))/2*AllEle(i,5),AllEle(i,8)-abs(Ds(Index(i)))/2*AllEle(i,5)],[AllEle(i,9)-abs(Ds(Index(i)))/2*AllEle(i,6),AllEle(i,9)+abs(Ds(Index(i)))/2*AllEle(i,6)],'bo','Markersize',4,'LineWidth',1.0);
        else
           % plot([AllEle(i,8)+abs(Ds(Index(i)))/2*AllEle(i,5),AllEle(i,8)-abs(Ds(Index(i)))/2*AllEle(i,5)],[AllEle(i,9)-abs(Ds(Index(i)))/2*AllEle(i,6),AllEle(i,9)+abs(Ds(Index(i)))/2*AllEle(i,6)],'r','LineWidth',0.5);
            ...
            plot([AllEle(i,8)+abs(Ds(Index(i)))/2*AllEle(i,5),AllEle(i,8)-abs(Ds(Index(i)))/2*AllEle(i,5)],[AllEle(i,9)-abs(Ds(Index(i)))/2*AllEle(i,6),AllEle(i,9)+abs(Ds(Index(i)))/2*AllEle(i,6)],'ro','Markersize',4,'LineWidth',1.0);
        end
...
n = (Ly/Lx);
set(1,'Position',[20 100 500 500*n])
saveas(1,[FILEPATH,num2str(nt),'Open.fig']);
%close(1);
%close(3);
end