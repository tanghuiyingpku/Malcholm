function HorizontalWellModule(welli,CurT)
% Using WU KAN' MODEL BUT WITH NewTonian Fluid
global well  Mat IndexInv Index
global nAct
global PresF_global  Fluid  ActEle
...
P = zeros(nAct,1);
for i = 1 : nAct
    P(i) = PresF_global(IndexInv(i))*1e6;
end
%unknowns P0 Qf1,2,3...
...
K2 = 128*visco_slv/pi/wellD^4*Qchara/PZchara*1;D
