function  [dt,DD_new,e_new,Pre_new,AllElenew] =FluidSolidFullCouple_Noflow_Recons(CurT,EleType,Mat,P_pre,DD_pre,dt,nAllEle,AllEle,ConnList,nFracture,Fractures,isGrow)
   ...
   %    HorizontalWellModule(CurT,P)
        ...
        for ii = 1 : nwell
            for jj = 1 : well{ii}.nPerf
                ...
                RHS(num+nAct) = RHS(num+nAct) + 0.05;%well{ii}.PerfQ(jj);
            end
        end
